...
def test_instantiation():
    seasons = Seasons([Season('spring', [0, 20])])
...
def test_eq():
    seasons1 = Seasons([Season('spring', [0, 20])])
    seasons2 = Seasons([Season('spring', [0, 20])])
    seasons3 = Seasons([Season('spring', [0, 20]), Season('summer', [15, 35])])
